...
class KeychainSDK {
    constructor(window, options) {
         ...
         * @memberof KeychainSDK
         */
        this.encodeWithKeys = (data) => __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    yield this.isKeychainInstalled();
                    this.window.hive_keychain.requestEncodeWithKeys(data.username, data.publicKeys, data.message, data.method, (response) => {
                        if (response.error) {
                            reject(response);
                        }
                        else {
        ...
        this.swap = {
             ...
             * @memberof KeychainSDK
             */
            getEstimation: (amount, startToken, endToken, swapConfig) => __awaiter(this, void 0, void 0, function* () {
                const req = yield (yield fetch(`${swap_1.SwapConf.baseURL}/token-swap/estimate/${startToken}/${endToken}/${amount + ''}`)).json();
                if (req.error)
                    throw new Error(req.error.message);
                const steps = req.result;
            ...
            getConfig: swap_1.getConfig,
            getServerStatus: swap_1.getServerStatus,
            start: (data, options = {}) => __awaiter(this, void 0, void 0, function* () {
                return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                    try {
                        yield this.isKeychainInstalled();
                        this.window.hive_keychain.requestSwap(data.username, data.startToken, data.endToken, data.amount, data.slippage, data.steps, (response) => {
                            if (response.error) {
                                reject(response);
                            }
                            else {
