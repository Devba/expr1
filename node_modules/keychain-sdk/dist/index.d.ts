...
import { AddAccount, AddAccountAuthority, AddKeyAuthority, Broadcast, Convert, CreateClaimedAccount, CreateProposal, Custom, Decode, Delegation, Encode, EncodeWithKeys, Login, Post, PowerDown, PowerUp, Proxy, RecurrentTransfer, RemoveAccountAuthority, RemoveKeyAuthority, RemoveProposal, SendToken, SignBuffer, SignTx, Swap, Transfer, UpdateProposalVote, Vote, WitnessVote } from './interfaces/keychain-sdk.interface';
...
export declare class KeychainSDK {
     ...
     * @memberof KeychainSDK
     */
    encodeWithKeys: (data: EncodeWithKeys) => Promise<KeychainRequestResponse>;
    /**
     * @description
    ...
    swap: {
         ...
         * @memberof KeychainSDK
         */
        getEstimation: (amount: number, startToken: string, endToken: string, swapConfig: SwapConfig) => Promise<{
            steps: IStep[];
            feePct: number;
            estimationBeforeFee: number;
            estimationAfterFee: number;
        }>;
        getConfig: () => Promise<SwapConfig>;
        getServerStatus: () => Promise<import("./utils/swap").SwapServerStatus>;
        start: (data: Swap, options?: KeychainOptions) => Promise<unknown>;
    };
}
